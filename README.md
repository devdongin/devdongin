...
소프트웨어 레이어 중 가장 낮은 곳 (Windows 커널)부터 가장 높은곳인 AI 까지 다루는 C++ 개발자입니다.  
...
- 백엔드 공부중(FastAPI)
- 하네스 주제 찾는중..
- 🤖 AI 모델을 C++ 추론 최적화 딥다이브
- 🔍 WinDbg로 크래시 덤프 뒤지면서 범인 찾기
- 🍎 AI 코딩 하네스와 함께 **macOS 앱**에도 도전 중

> 🌱 진짜 커밋들은 회사 조직 프라이빗 저장소에 있습니다. (toy포함)

### 🔗 더 보기
**[📄 포트폴리오](https://devdongin.github.io)**. 
**[✍️ 블로그](https://he11oworld.tistory.com)**. 
**📮 devdongin@gmail.com**
